document.addEventListener('DOMContentLoaded', function () {
    ...
    async function getExpenditure() {
        ...
        try {
            ...
            if (!swiperWrapperDate) throw new Error("Swiper wrapper for dates not found");
            ...
            if (!swiperWrapperType) throw new Error("Swiper wrapper for type of expenditure not found");
